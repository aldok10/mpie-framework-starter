...
use Mpie\Database\Connector\SwoolePoolConnector;
...
return [
    ...
    'connections' => [
        ...
        'pgsql' => [
            'connector' => BaseConnector::class,
            'options'   => [
                DBConfig::OPTION_DRIVER      => 'pgsql',
                DBConfig::OPTION_HOST        => env('DB_HOST', 'postgres'),
                DBConfig::OPTION_USER        => env('DB_USER', 'postgres'),
                DBConfig::OPTION_UNIX_SOCKET => null,
                DBConfig::OPTION_PASSWORD    => env('DB_PASS', 'changeme'),
                DBConfig::OPTION_DB_NAME     => env('DB_NAME', 'mpie_demo'),
                DBConfig::OPTION_PORT        => env('DB_PORT', 5432),
                DBConfig::OPTION_OPTIONS     => [],
                DBConfig::OPTION_CHARSET     => env('DB_CHARSET', 'utf8'),
                DBConfig::OPTION_POOL_SIZE   => 12,
            ],
        ]
    ],
